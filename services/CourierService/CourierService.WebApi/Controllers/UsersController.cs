...
using CourierService.Application.UseCases.ConfirmUser;
using CourierService.Application.UseCases.CreateUser;
using CourierService.Application.UseCases.DeleteUser;
using CourierService.Application.UseCases.GetUserById;
using MediatR;
