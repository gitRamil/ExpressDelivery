...
using AuthorizationServer.Application.UseCases.ConfirmUser;
using AuthorizationServer.Application.UseCases.CreateUser;
using AuthorizationServer.Application.UseCases.DeleteUser;
using AuthorizationServer.Application.UseCases.GetUserById;
using MediatR;
using Microsoft.AspNetCore.Authorization;

namespace AuthorizationServer.WebApi.Controllers;
/// <summary>
