using AuthorizationServer.Application.Behaviors;
using AuthorizationServer.WebApi.Infrastructure.Security;
using Flurl;
...
using static AuthorizationServer.WebApi.Infrastructure.Options.IdentityProviderOptions;
...
internal sealed class SwaggerGenOptionsConfigure : IConfigureOptions<SwaggerGenOptions>
{
    ...
    public void Configure(SwaggerGenOptions swaggerGenOptions)
    {
        ...
        swaggerGenOptions.SwaggerDoc("v1",
                                     new OpenApiInfo
                                     {
                                         Title = "AuthorizationServer API здесь указать заголовок",
                                         Description = "AuthorizationServer здесь указать описание"
                                     });
