...
using LiveLocationService.Application.UseCases.ConfirmUser;
using LiveLocationService.Application.UseCases.CreateUser;
using LiveLocationService.Application.UseCases.DeleteUser;
using LiveLocationService.Application.UseCases.GetUserById;
using MediatR;
using Microsoft.AspNetCore.Authorization;

namespace LiveLocationService.WebApi.Controllers;
/// <summary>
