...
using Flurl;
using Microservice.Application.Behaviors;
using Microservice.WebApi.Infrastructure.Security;
using Microsoft.Extensions.Options;
using Microsoft.OpenApi.Extensions;
using Microsoft.OpenApi.Models;
using Swashbuckle.AspNetCore.SwaggerGen;
using static Microservice.WebApi.Infrastructure.Options.IdentityProviderOptions;

namespace Microservice.WebApi.Infrastructure.Options;
...
internal sealed class SwaggerGenOptionsConfigure : IConfigureOptions<SwaggerGenOptions>
{
    ...
    public void Configure(SwaggerGenOptions swaggerGenOptions)
    {
        ...
        swaggerGenOptions.SwaggerDoc("v1",
                                     new OpenApiInfo
                                     {
                                         Title = "Microservice API здесь указать заголовок",
                                         Description = "Microservice здесь указать описание"
                                     });
